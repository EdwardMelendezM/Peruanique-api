# Skill: nextjs-sodu-form-edit-generator
...
4. **Action Routing**: Al terminar con éxito, usar `router.refresh()` para actualizar los datos en la tabla y opcionalmente `router.back()`.
